...
namespace Commander.Controllers
{
    ...
    public class CommandsController : ControllerBase
    {
        ...
        public ActionResult<CommandReadDto> CreateCommand(CommandCreateDto createDto)
        {
            ...
            var commmandReadDto = _mapper.Map<CommandReadDto>(commandModel);
           //  return Ok(commmandReadDto);

            return CreatedAtRoute(nameof(GetCommandById), new { Id = commmandReadDto.Id }, commmandReadDto);
        }
        ...
        [HttpDelete("{id}")]
        public ActionResult DeleteACommand(int id)
        {
            var commandModelFromRepo = _repository.GetCommandById(id);
            if (commandModelFromRepo == null)
                return NotFound();
